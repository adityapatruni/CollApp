...
public class WebEndpointInfoTest {
	...
	@Test
	public void endpointInfoTest() throws Exception {
		mockMvc.perform(get("/api/admin/endpoint-info").accept("application/json").session(TestWebConf.SESSION))
