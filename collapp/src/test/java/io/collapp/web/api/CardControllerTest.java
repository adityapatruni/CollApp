...
import io.collapp.web.api.CardController;
import io.collapp.web.api.CardController.CardData;
import io.collapp.web.api.CardController.ColumnOrders;
...
public class CardControllerTest {
    ...
    public void createWithFiles() {
        ...
        ImmutablePair<Boolean, io.collapp.model.CardData> result = new ImmutablePair<>(true,
            new io.collapp.model.CardData(1, cardId, null, CardType.FILE, null, 0));
