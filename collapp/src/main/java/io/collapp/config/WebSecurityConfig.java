...
import io.collapp.web.security.SecurityConfiguration.*;
import io.collapp.web.security.login.DemoLogin;
import io.collapp.web.security.login.LdapLogin;
import io.collapp.web.security.login.PasswordLogin;
...
public class WebSecurityConfig {
    ...
    private static class WebSecurityUser implements User {
        ...
        private WebSecurityUser(io.collapp.model.User user) {
            this.id = user.getId();
