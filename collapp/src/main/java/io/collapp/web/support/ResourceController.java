...
public class ResourceController {
    ...
    public ResourceController(collappEnvironment env) {
        this.env = env;
    ...
    private void addMessages(ServletContext context, OutputStream os, BeforeAfter ba) throws IOException {
        ...
        Resource[] resources = resolver.getResources("classpath:io/collapp/i18n/messages_*.properties");
        //
        os.write(("window.io_collapp=window.io_collapp||{};window.io_collapp.i18n=" + Json.GSON
