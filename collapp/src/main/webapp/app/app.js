(function () {
    ...
    window.csrfToken = window.document.documentElement.getAttribute('collapp-csrf');
    ...
    angular.module('collapp.components', [ 'collapp.services' ]);
    angular.module('collapp.directives', [ 'collapp.services' ]);
    angular.module('collapp.filters', []);
    angular.module('collapp.services', []);
    //

    var module = angular.module('collapp', [ 'ui.router', 'collapp.services',
        'collapp.components', 'collapp.filters', 'collapp.directives',
    ...
    module.constant('LOCALE_FIRST_DAY_OF_WEEK', document.getElementsByTagName('html')[0].getAttribute('data-collapp-first-day-of-week'));
    ...
    module.config(function ($stateProvider, $urlRouterProvider, $locationProvider, $translateProvider, $mdThemingProvider, $mdIconProvider, $mdInkRippleProvider, $compileProvider, $qProvider) {
        ...
        angular.forEach(io_collapp.i18n, function (map, lang) {
        ...
        if (true) { /* eslint no-constant-condition: 0 */
            ...
            $mdThemingProvider.definePalette('collapp-background', background);

            $mdThemingProvider.theme('default')
                .primaryPalette('blue-grey')
                .accentPalette('light-blue')
                .warnPalette('red')
                .backgroundPalette('collapp-background');
    ...
    module.factory('collappHttpInterceptor', function ($q, $window) {
        //
        return {
    ...
    module.config(function ($httpProvider) {
        $httpProvider.interceptors.push('collappHttpInterceptor');
